...
public class LameUtil {
	 ...
	 *
	 * @param inSamplerate
	 *            输入采样频率 Hz input sample rate in Hz.
	 * @param inChannel
	 *            输入声道数 number of channels in input stream.
	 * @param outSamplerate
	 *            输出采样频率 Hz output sample rate in Hz.
	 * @param outBitrate
	 *            压缩比 brate compression ratio in KHz.
	 * @param quality
	 *            MP3音频质量，最好0最差9 quality=0..9. 0=best (very slow). 9=worst.<br />
	 *            recommended:<br />
